    ...
    if element.tag == 'node':
        ...
        for child in element:
            ...
            if LOWER_COLON.match(child.attrib['k']):
                ...
                #node_tag['value'] = child.attrib['v'] #Have changed here. commented this out and put the below line instead
                node_tag['value'] = audit.update_name(child.attrib['v'], )
        ...
        for child in element:
            ...
            if child.tag == 'tag':
                if LOWER_COLON.match(child.attrib['k']):
                    ...
                    #way_tag['value'] = child.attrib['v']	#Have changed here. commented this out and put the below line instead
                    way_tag['value'] = audit.update_name(child.attrib['v'], )
                    tags.append(way_tag)
                elif PROBLEMCHARS.match(child.attrib['k']):
                    continue
                else:
